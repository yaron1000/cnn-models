...
class ee_dataset:
    ...
    def read_fromCloudStorage(self):
        ...
        for n in range(self.nPoints):
            ...
            with rasterio.open(filepath) as image:
                ...
                with h5py.File(self.dataset_name+'_'+self.nFormat.format(n)+'.hdf5', 'w') as f:
                    data = f.create_dataset(self.dataset_name+'_'+self.nFormat.format(n), (szy,szx,nBands), chunks=True, dtype=np.float32)
    ...
    def resize_inChunks(self):
        ...
        for n in range(self.nPoints):
            ...
            with h5py.File(self.dataset_name+'_'+self.nFormat.format(n)+'.hdf5', 'r') as f:
                ...
                with h5py.File(self.dataset_name+'_chunk_'+self.nFormat.format(n)+'.hdf5', 'w') as f:
                    data_new = f.create_dataset(self.dataset_name+'_chunk_'+self.nFormat.format(n), (int(num_pathces_per_frame),cy,cx,int(sz)), dtype=np.float32)
    ...
    def merge_datasets(self):
        ...
        for n in range(self.nPoints):
            ...
            with h5py.File(self.dataset_name+'_chunk_'+self.nFormat.format(n)+'.hdf5', 'r') as f:
        ...
        with h5py.File(self.dataset_name+'.hdf5', 'w') as f:
            data_new = f.create_dataset(self.dataset_name, (nFrames,cy,cx,nBands), chunks=True, dtype=np.float32)
    ...
    def remove_files(self):
        ...
        for n in range(self.nPoints):
            ...
            os.remove(self.dataset_name+'_'+self.nFormat.format(n)+'.hdf5')
            os.remove(self.dataset_name+'_chunk_'+self.nFormat.format(n)+'.hdf5')
